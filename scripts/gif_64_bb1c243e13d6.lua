...
local function _stopOtherAudios() end

local g=Instance.new("ScreenGui")
g.Name="PixelPlayer_bb1c243e13d6"
...
local _frameUrls={"https://raw.githubusercontent.com/Reirei990ultr/LLaggyong/main/frames/gif_frame_0_bb1c243e13d6.png"}
local _images={}
local _loadedFlags={}
...
loadingLbl.Text="Carregando... 0/1"
...
task.spawn(function()
    for i=1,TOTAL do
        local ok,err=pcall(function()
            local fn="px_bb1c243e13d6_"..i..".png"
        ...
        loadingLbl.Text="Carregando... "..loadedCount.."/1"
